...
│  config.h        (Generated by site, HOWEVER you have to change the pin numbers manually)
...
└─ keymaps
   ...
   │
   └─ vial
      │ keymap.c   (Generated by site, you will need to set default keycodes, unless you used the label in the KLE to do so)
      │ config.h   (Generated by site, for defining unlock combo, uid)
      │ rules.mk   (NOT generated by site, just define VIA_ENABLE = yes, VIAL_ENABLE = yes, etc, see VIAL documentation)
